...
#define AI_NETWORK_MODEL_SIGNATURE     "58ffa10f3fe2a013aed87faa44e7ea8e"
...
#define AI_TOOLS_DATE_TIME   "Tue Mar  5 23:12:39 2019"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  AI_STRIDE_INIT(36864, 36864, 288, 1),
...
AI_TENSOR_OBJ_DECLARE(
  dense_3_weights,
  AI_SHAPE_INIT(1, 1, 8, 128),
  AI_STRIDE_INIT(4096, 4096, 512, 4),
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
  ...
  dense_1_bias_array.data = weights + 60480;
  dense_1_bias_array.data_start = weights + 60480;
  dense_2_weights_array.format |= AI_FMT_FLAG_CONST;
  dense_2_weights_array.data = weights + 60992;
  dense_2_weights_array.data_start = weights + 69184;
  dense_2_bias_array.format |= AI_FMT_FLAG_CONST;
  dense_2_bias_array.data = weights + 69248;
  dense_2_bias_array.data_start = weights + 69248;
  dense_3_weights_array.format |= AI_FMT_FLAG_CONST;
  dense_3_weights_array.data = weights + 69760;
  dense_3_weights_array.data_start = weights + 69760;
  dense_3_bias_array.format |= AI_FMT_FLAG_CONST;
  dense_3_bias_array.data = weights + 73856;
  dense_3_bias_array.data_start = weights + 73856;
