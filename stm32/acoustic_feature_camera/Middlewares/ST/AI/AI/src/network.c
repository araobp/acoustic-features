...
#define AI_NETWORK_MODEL_SIGNATURE     "c56a94b811bbc155d0ecb27da43d67b2"
...
#define AI_TOOLS_DATE_TIME   "Tue Mar  5 15:55:19 2019"
...
AI_TENSOR_OBJ_DECLARE(
  dense_4_weights,
  AI_SHAPE_INIT(1, 1, 6, 576),
  AI_STRIDE_INIT(3456, 3456, 576, 1),
  ...
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
  ...
  dense_4_output_array.data = activations + 4608;
  dense_4_output_array.data_start = activations + 4608;
  dense_4_nl_output_array.data = activations + 4608;
  dense_4_nl_output_array.data_start = activations + 4608;
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
  ...
  dense_4_weights_array.data = weights + 23552;
  dense_4_weights_array.data_start = weights + 27008;
  dense_4_bias_array.format |= AI_FMT_FLAG_CONST;
  dense_4_bias_array.data = weights + 28032;
  dense_4_bias_array.data_start = weights + 28032;
