...
#define AI_NETWORK_MODEL_SIGNATURE     "d68f7f0443642681ffdc35b7661cbd60"
...
#define AI_TOOLS_DATE_TIME   "Sun Feb 10 00:12:09 2019"
...
AI_STATIC ai_array conv2d_47_output_array;   /* Array #1 */
AI_STATIC ai_array conv2d_48_output_array;   /* Array #2 */
AI_STATIC ai_array conv2d_49_output_in_array;   /* Array #3 */
AI_STATIC ai_array conv2d_49_output_out_array;   /* Array #4 */
AI_STATIC ai_array dense_19_output_array;   /* Array #5 */
AI_STATIC ai_array dense_19_nl_output_array;   /* Array #6 */


/**  Forward network tensors declarations  ************************************/
AI_STATIC ai_tensor input_0_output;   /* Tensor #0 */
AI_STATIC ai_tensor conv2d_47_output;   /* Tensor #1 */
AI_STATIC ai_tensor conv2d_48_output;   /* Tensor #2 */
AI_STATIC ai_tensor conv2d_49_output_in;   /* Tensor #3 */
AI_STATIC ai_tensor conv2d_49_output_out;   /* Tensor #4 */
AI_STATIC ai_tensor dense_19_output;   /* Tensor #5 */
AI_STATIC ai_tensor dense_19_nl_output;   /* Tensor #6 */


/**  Forward network tensor chain declarations  *******************************/
AI_STATIC_CONST ai_tensor_chain conv2d_47_chain;   /* Chain #0 */
AI_STATIC_CONST ai_tensor_chain conv2d_48_chain;   /* Chain #1 */
AI_STATIC_CONST ai_tensor_chain conv2d_49_chain;   /* Chain #2 */
AI_STATIC_CONST ai_tensor_chain dense_19_chain;   /* Chain #3 */
AI_STATIC_CONST ai_tensor_chain dense_19_nl_chain;   /* Chain #4 */
...
AI_STATIC ai_layer_conv2d_nl_pool conv2d_47_layer; /* Layer #0 */
AI_STATIC ai_layer_conv2d_nl_pool conv2d_48_layer; /* Layer #1 */
AI_STATIC ai_layer_conv2d_nl_pool conv2d_49_layer; /* Layer #2 */
AI_STATIC ai_layer_dense dense_19_layer; /* Layer #3 */
AI_STATIC ai_layer_sm dense_19_nl_layer; /* Layer #4 */
...
AI_ARRAY_OBJ_DECLARE(
  ...
  AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
  conv2d_47_output_array, AI_DATA_FORMAT_FLOAT, 
  NULL, NULL, 2356,
  AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
  conv2d_48_output_array, AI_DATA_FORMAT_FLOAT, 
  NULL, NULL, 896,
  AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
  conv2d_49_output_in_array, AI_DATA_FORMAT_FLOAT, 
  NULL, NULL, 288,
  AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
  conv2d_49_output_out_array, AI_DATA_FORMAT_FLOAT, 
  NULL, NULL, 288,
  AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
  dense_19_output_array, AI_DATA_FORMAT_FLOAT, 
  NULL, NULL, 6,
  AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
  dense_19_nl_output_array, AI_DATA_FORMAT_FLOAT, 
  NULL, NULL, 6,
  AI_STATIC)
...
/* Layer #0: "conv2d_47" (Conv2D) */
  

/* Weight tensor #1 */
AI_ARRAY_OBJ_DECLARE(
  conv2d_47_weights_array, AI_DATA_FORMAT_FLOAT, 
  NULL, NULL, 36,
  AI_STATIC)
...
/* Weight tensor #2 */
AI_ARRAY_OBJ_DECLARE(
  conv2d_47_bias_array, AI_DATA_FORMAT_FLOAT, 
  NULL, NULL, 4,
  AI_STATIC)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  conv2d_47_chain, AI_STATIC_CONST, 
  AI_TENSOR_LIST_ENTRY(&input_0_output),
  AI_TENSOR_LIST_ENTRY(&conv2d_47_output),
  AI_TENSOR_LIST_ENTRY(&conv2d_47_weights, &conv2d_47_bias),
...
/* Layer #1: "conv2d_48" (Conv2D) */
  

/* Weight tensor #1 */
AI_ARRAY_OBJ_DECLARE(
  conv2d_48_weights_array, AI_DATA_FORMAT_FLOAT, 
  NULL, NULL, 288,
  AI_STATIC)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  &conv2d_48_weights_array,
  AI_STATIC)

/* Weight tensor #2 */
AI_ARRAY_OBJ_DECLARE(
  conv2d_48_bias_array, AI_DATA_FORMAT_FLOAT, 
  NULL, NULL, 8,
  AI_STATIC)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  &conv2d_48_bias_array,
  AI_STATIC)


AI_TENSOR_CHAIN_OBJ_DECLARE(
  conv2d_48_chain, AI_STATIC_CONST, 
  AI_TENSOR_LIST_ENTRY(&conv2d_47_output),
  AI_TENSOR_LIST_ENTRY(&conv2d_48_output),
  AI_TENSOR_LIST_ENTRY(&conv2d_48_weights, &conv2d_48_bias),
  AI_TENSOR_LIST_EMPTY
)
...
/* Layer #2: "conv2d_49" (Conv2D) */
  

/* Weight tensor #1 */
AI_ARRAY_OBJ_DECLARE(
  conv2d_49_weights_array, AI_DATA_FORMAT_FLOAT, 
  NULL, NULL, 1152,
  AI_STATIC)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  &conv2d_49_weights_array,
  AI_STATIC)

/* Weight tensor #2 */
AI_ARRAY_OBJ_DECLARE(
  conv2d_49_bias_array, AI_DATA_FORMAT_FLOAT, 
  NULL, NULL, 16,
  AI_STATIC)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  &conv2d_49_bias_array,
  AI_STATIC)


AI_TENSOR_CHAIN_OBJ_DECLARE(
  conv2d_49_chain, AI_STATIC_CONST, 
  AI_TENSOR_LIST_ENTRY(&conv2d_48_output),
  AI_TENSOR_LIST_ENTRY(&conv2d_49_output_in),
  AI_TENSOR_LIST_ENTRY(&conv2d_49_weights, &conv2d_49_bias),
  AI_TENSOR_LIST_EMPTY
)
...
/* Weight tensor #1 */
AI_ARRAY_OBJ_DECLARE(
  dense_19_weights_array, AI_DATA_FORMAT_LUT8_FLOAT, 
  NULL, NULL, 1728,
  AI_STATIC)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  &dense_19_weights_array,
  AI_STATIC)

/* Weight tensor #2 */
AI_ARRAY_OBJ_DECLARE(
  dense_19_bias_array, AI_DATA_FORMAT_FLOAT, 
  NULL, NULL, 6,
  AI_STATIC)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  dense_19_chain, AI_STATIC_CONST, 
  AI_TENSOR_LIST_ENTRY(&conv2d_49_output_out),
  AI_TENSOR_LIST_ENTRY(&dense_19_output),
  AI_TENSOR_LIST_ENTRY(&dense_19_weights, &dense_19_bias),
  AI_TENSOR_LIST_EMPTY
)
...
/* Layer #4: "dense_19_nl" (Nonlinearity) */
  


AI_TENSOR_CHAIN_OBJ_DECLARE(
  dense_19_nl_chain, AI_STATIC_CONST, 
  AI_TENSOR_LIST_ENTRY(&dense_19_output),
  AI_TENSOR_LIST_ENTRY(&dense_19_nl_output),
  AI_TENSOR_LIST_EMPTY,
  AI_TENSOR_LIST_EMPTY
)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 13060, 1,
                     NULL),
  &input_0_output, &dense_19_nl_output,
  &conv2d_47_layer, 0)
