...
#define AI_NETWORK_MODEL_SIGNATURE     "7fb86110bd281fccae606b7a6fee73ce"
...
#define AI_TOOLS_DATE_TIME   "Thu Feb 28 16:32:25 2019"
...
AI_STATIC ai_array conv2d_23_output_array;   /* Array #1 */
AI_STATIC ai_array conv2d_24_output_in_array;   /* Array #2 */
AI_STATIC ai_array conv2d_24_output_out_array;   /* Array #3 */
AI_STATIC ai_array dense_8_output_array;   /* Array #4 */
AI_STATIC ai_array dense_8_nl_output_array;   /* Array #5 */


/**  Forward network tensors declarations  ************************************/
AI_STATIC ai_tensor input_0_output;   /* Tensor #0 */
AI_STATIC ai_tensor conv2d_23_output;   /* Tensor #1 */
AI_STATIC ai_tensor conv2d_24_output_in;   /* Tensor #2 */
AI_STATIC ai_tensor conv2d_24_output_out;   /* Tensor #3 */
AI_STATIC ai_tensor dense_8_output;   /* Tensor #4 */
AI_STATIC ai_tensor dense_8_nl_output;   /* Tensor #5 */


/**  Forward network tensor chain declarations  *******************************/
AI_STATIC_CONST ai_tensor_chain conv2d_23_chain;   /* Chain #0 */
AI_STATIC_CONST ai_tensor_chain conv2d_24_chain;   /* Chain #1 */
...
AI_STATIC ai_layer_conv2d_nl_pool conv2d_23_layer; /* Layer #0 */
AI_STATIC ai_layer_conv2d_nl_pool conv2d_24_layer; /* Layer #1 */
AI_STATIC ai_layer_dense dense_8_layer; /* Layer #2 */
AI_STATIC ai_layer_sm dense_8_nl_layer; /* Layer #3 */
...
AI_ARRAY_OBJ_DECLARE(
  ...
  AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
  conv2d_23_output_array, AI_DATA_FORMAT_FLOAT, 
  NULL, NULL, 920,
  AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
  conv2d_24_output_in_array, AI_DATA_FORMAT_FLOAT, 
  NULL, NULL, 240,
  AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
  conv2d_24_output_out_array, AI_DATA_FORMAT_FLOAT, 
  NULL, NULL, 240,
  AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
...
/* Layer #0: "conv2d_23" (Conv2D) */
  

/* Weight tensor #1 */
AI_ARRAY_OBJ_DECLARE(
  conv2d_23_weights_array, AI_DATA_FORMAT_FLOAT, 
  NULL, NULL, 72,
  AI_STATIC)
...
/* Weight tensor #2 */
AI_ARRAY_OBJ_DECLARE(
  conv2d_23_bias_array, AI_DATA_FORMAT_FLOAT, 
  NULL, NULL, 8,
  AI_STATIC)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  conv2d_23_chain, AI_STATIC_CONST, 
  AI_TENSOR_LIST_ENTRY(&input_0_output),
  AI_TENSOR_LIST_ENTRY(&conv2d_23_output),
  AI_TENSOR_LIST_ENTRY(&conv2d_23_weights, &conv2d_23_bias),
...
AI_LAYER_OBJ_DECLARE(
  ...
  .pool_size = AI_SHAPE_2D_INIT(4, 2), 
  .pool_stride = AI_SHAPE_2D_INIT(4, 2), 
  .pool_pad = AI_SHAPE_2D_INIT(0, 0), 
  .pool_func = pool_func_mp_array_f32, 
)

/* Layer #1: "conv2d_24" (Conv2D) */
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_ENTRY(&conv2d_23_output),
  AI_TENSOR_LIST_ENTRY(&conv2d_24_output_in),
...
/* Weight tensor #1 */
AI_ARRAY_OBJ_DECLARE(
  dense_8_weights_array, AI_DATA_FORMAT_LUT8_FLOAT, 
  NULL, NULL, 1440,
  AI_STATIC)

AI_TENSOR_OBJ_DECLARE(
  dense_8_weights,
  AI_SHAPE_INIT(1, 1, 6, 240),
  AI_STRIDE_INIT(1440, 1440, 240, 1),
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_ENTRY(&conv2d_24_output_out),
  ...
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
  ...
  conv2d_23_output_array.data = activations + 0;
  conv2d_23_output_array.data_start = activations + 0;
  conv2d_24_output_in_array.data = activations + 3712;
  conv2d_24_output_in_array.data_start = activations + 3712;
  conv2d_24_output_out_array.data = activations + 3712;
  conv2d_24_output_out_array.data_start = activations + 3712;
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
  ...
  conv2d_23_weights_array.data = weights + 0;
  conv2d_23_weights_array.data_start = weights + 0;
  conv2d_23_bias_array.format |= AI_FMT_FLAG_CONST;
  conv2d_23_bias_array.data = weights + 288;
  conv2d_23_bias_array.data_start = weights + 288;
  conv2d_24_weights_array.format |= AI_FMT_FLAG_CONST;
  conv2d_24_weights_array.data = weights + 320;
  conv2d_24_weights_array.data_start = weights + 320;
  conv2d_24_bias_array.format |= AI_FMT_FLAG_CONST;
  conv2d_24_bias_array.data = weights + 4928;
  conv2d_24_bias_array.data_start = weights + 4928;
  dense_8_weights_array.format |= AI_FMT_FLAG_CONST;
  dense_8_weights_array.data = weights + 4992;
  dense_8_weights_array.data_start = weights + 6432;
  dense_8_bias_array.format |= AI_FMT_FLAG_CONST;
  dense_8_bias_array.data = weights + 7456;
  dense_8_bias_array.data_start = weights + 7456;
