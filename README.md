...
I have discoverd that **low-end edge AI works very well** as long as the conditions described in this README are satisfied. If simple classification is a requirment, think of low-cost AI based on MCU before MPU/FPGA/GPU!
 ...
 I find the "life-log" use case in this project works very well, but the problem is that it takes a lot of efforts (= cost) to train a neural network. This is my hobboy project, and I do not need to worry about if this can make a profit or not.
