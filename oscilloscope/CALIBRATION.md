...
![Welch's method with pre-emphasis disabled](./calibration/welch_pre_emphasis_disabled.png)

![Welch's method with pre-emphasis enabled](./calibration/welch_pre_emphasis_enabled.png)
